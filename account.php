	...
	<div class="row">
            ...
            <div id="myTabContent" class="tab-content">
              <div class="tab-pane fade active in" id="home">
			            ...
			            <h4>顯示會員資料</h4>
                  <div align="center">
                  <span style="font-size:15pt;color:blue;font-weight:bold">顯示會員資料</span>
                  <form name='form1' method='POST' action=''>
                  	<table border="1" width="500" id="table1">
                      <tr>
                  			<td width="100" align="center">帳號</td>
                  			<td align="center"><h4><?= $row[3] ?><h4></td>
                  		</tr>
                  		<tr>
                  			<td width="100" align="center">密碼</td>
                  			<td align="center"><h4><?= $row[5] ?><h4></td>
                  		</tr>
                      <tr>
                  			<td width="100" align="center">信箱</td>
                  			<td align="center"><h4><?= $row[4] ?><h4></td>
                  		</tr>                  		
                  	</table>
                  </form>
                  <span></span>
