...
$pdf->SetHeaderData("",40, "", "商品名單", array(0,64,255), array(0,64,128));
...
$html = "<table border=\"1\"><tr align=\"center\"><td width=\"40%\">商品</td><td width=\"50%\">內容</td><td width=\"10%\">價格</td></tr>";
...
$html .= "<tr align=\"center\"><td width=\"40%\">".$row["name"]."</td><td width=\"50%\">".$row["content"]."</td><td width=\"10%\">".$row["cost"]."</td></tr>";
}
